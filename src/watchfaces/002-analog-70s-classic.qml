            ...
            Repeater {
                ...
                Shape {
                    ...
                    ShapePath {
                        ...
                        strokeWidth: rootitem.height * segmentedArc.arcStrokeWidth
                        ...
                        PathAngleArc {
                            ...
                            centerY: rootitem.height / 2
                            radiusX: segmentedArc.scalefactor * rootitem.width
                            radiusY: segmentedArc.scalefactor * rootitem.height
