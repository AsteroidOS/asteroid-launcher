 ...
 * \class VolumeControl
 *
 * \brief Tracks and sets the audio volume.
 *
 * Exposes the current and maximum volume and the volume-key events to
 * QML (the launcher's QuickPanel renders the volume slider).
 */
